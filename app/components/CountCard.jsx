...
export default function CountCard(props) {
  ...
  return (
    <Link
      href={props.href}
      class="group h-full flex flex-col justify-between gap-4 p-6 rounded-2xl border border-dashed border-[var(--otfw-accent)]/45 bg-[var(--otfw-accent-soft)] transition-colors hover:border-[var(--otfw-accent)]"
    >
      <div class="flex items-start justify-between gap-3">
        <span class="flex items-center justify-center w-10 h-10 rounded-xl bg-[var(--otfw-bg)]/60 text-[var(--accent-text)]">
      ...
      <div>
        ...
        <p class="mt-2 text-sm text-[var(--text-muted-on-accent)]">
